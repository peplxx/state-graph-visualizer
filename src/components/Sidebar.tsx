...
interface Props {
  ...
  systemConfig?: { tasks: Array<{ c: number; d: number; name?: string }>; m?: number };
  onClose: () => void;
}
      ...
      <div className="sidebar-body">
        ...
        {data.isInitial && (
          <div className="detail-row">
            ...
            <span className="badge badge-initial">Initial State</span>
          </div>
        )}
          ...
          <>
            ...
            {systemConfig.m !== undefined && (
              <div className="detail-row">
                ...
                <code className="detail-value">m = {systemConfig.m}</code>
              </div>
            )}
          </>
        )}
        ...
        <div className="detail-row">
          ...
          <code className="detail-value">{node.outdegree(false)}</code>
        </div>
      </div>
    </aside>
  );
